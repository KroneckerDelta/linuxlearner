...
This project based on [unix4j](https://github.com/tools4j/unix4j). Linux commands like find, grep or sed should be visualized [Snap!](http://snap.berkeley.edu) or [Scratch](https://scratch.mit.edu).
